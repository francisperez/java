...
public class Formulario extends javax.swing.JFrame {
    ...
    public void devolverCancion(){
        try {
            ...
            pst.setString(2, jTextField4.getText().toString());
            pst.setInt(3, Integer.parseInt(jTextField5.getText()));
            pst.setString(4, jTextField6.getText().toString());
            pst.setInt(5, Integer.parseInt(jTextField7.getText()));
            pst.executeUpdate();
    ...
    String dato2=jPasswordField1.getText().toString();
